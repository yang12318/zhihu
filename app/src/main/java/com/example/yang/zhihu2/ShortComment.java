...
public class ShortComment {
    ...
    String JsonLength;
    public ShortComment(String author,String id,String content,String avatar,String likes,String time,String reply_content,String reply_status,String reply_id,String reply_author,String reply_err_msg,String JsonLength){
        this.author=author;
        this.id=id;
