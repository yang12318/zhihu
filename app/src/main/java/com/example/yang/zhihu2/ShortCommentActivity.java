...
public class ShortCommentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button shortcomment_back=findViewById(R.id.shortcomment_back);
        ...
        shortcomment_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(ShortCommentActivity.this,ArticleActivity.class);
